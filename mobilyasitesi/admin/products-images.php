...
if(isset($_GET['ID'])){
  $ID = intval($_GET['ID']);
  $productsimagesInfo = productsimagesFind($ID);
  
}

print $productsimagesInfo ;
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form
                            action="<?php if($ID > 0) echo 'products-images_duzenle.php?ID='.$ID; else echo 'products-images_ekle.php' ?>"
                            method="post" role="form" enctype="multipart/form-data">
                            <label for="">Ürün Resmi</label>
                            <div class="form-group form-group-lg">
                                <?php if($ID > 0) { ?>
                                <img height="150"
                                    src="../uploads/products/buyuk/<?php echo $productsimagesInfo['Images']; ?>">
                                <?php } ?>
                            ...
                            <div class="form-group form-group-lg">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="Name"
                                        ...
                                        value="<?php echo $productsimagesInfo['Name']; ?>">
                                </div>
                            </div>
                        ...
                        <div id="aniimated-thumbnials" class="list-unstyled row clearfix">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                ...
                                <a class="btn btn-success"
                                    href="products-images.php?productsID=<?php echo $productsimagesList['productsID']; ?>&ID=<?php echo $productsimagesList['ID']; ?>">
                                    <i class="glyphicon glyphicon-zoom-in icon-white"></i>
                                    Düzenle
                                </a>
                                <a class="btn btn-danger"
                                    href="products-images_sil.php?productsID=<?php echo $productsimagesList['productsID']; ?>&ID=<?php echo $productsimagesList['ID']; ?>&Images=<?php echo $productsimagesList['Images']; ?>">
